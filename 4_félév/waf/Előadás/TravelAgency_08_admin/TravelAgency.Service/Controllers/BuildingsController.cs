...
namespace ELTE.TravelAgency.Service.Controllers
{
    ...
    public class BuildingsController : ControllerBase
    {
        ...
        public IActionResult GetBuildings()
        {
            try
            {
                return Ok(_context.Buildings.ToList().Select(building => new BuildingDTO
                {
                    Id = building.Id,
                    Name = building.Name,
        ...
        public IActionResult GetBuilding(Int32 id)
        {
            try
            {
                var building = _context.Buildings.Single(b => b.Id == id);
		...
		public IActionResult GetBuildingForCity(Int32 id)
        {
            try
            {
                return Ok(_context.Buildings.Where(b => b.CityId == id).ToList().Select(building => new BuildingDTO
                {
                    Id = building.Id,
                    Name = building.Name,
                    CityId = building.CityId,
        ...
        public IActionResult PutBuilding([FromBody] BuildingDTO buildingDTO)
        {
            try
            {
                ...
                building.Features = buildingDTO.Features;
