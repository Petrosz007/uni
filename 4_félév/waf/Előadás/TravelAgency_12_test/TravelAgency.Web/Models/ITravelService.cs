...
namespace ELTE.TravelAgency.Web.Models
{
    ...
    public interface ITravelService
    {
        ...
        Task<Boolean> SaveRentAsync(Int32? apartmentId, String userName, RentViewModel rent);
        ...
        IEnumerable<DateTime> GetRentDates(Int32 apartmentId, Int32 year, Int32 month);
    }
}
