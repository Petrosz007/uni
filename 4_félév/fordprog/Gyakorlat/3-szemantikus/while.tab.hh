...
#line 125 "while.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const type v, const location_type& l);
    ...
    static inline
    symbol_type
    make_UNT (const location_type& l);
    ...
    static inline
    symbol_type
    make_UPTO (const location_type& l);

    static inline
    symbol_type
    make_DWTO (const location_type& l);
    ...
    static inline
    symbol_type
    make_SOP (const location_type& l);

    static inline
    symbol_type
    make_SCL (const location_type& l);
    ...
    static inline
    symbol_type
    make_DATELIT (const location_type& l);

    static inline
    symbol_type
    make_GETY (const location_type& l);

    static inline
    symbol_type
    make_GETM (const location_type& l);

    static inline
    symbol_type
    make_GETD (const location_type& l);
    ...
    static inline
    symbol_type
    make_QW (const location_type& l);

    static inline
    symbol_type
    make_CO (const location_type& l);
...
#line 878 "while.tab.hh" // lalr1.cc:377
...
#line 886 "while.tab.hh" // lalr1.cc:377
