...
# a világ különbözõ részein található szerverek, melyek mindegyikén 
# elérhetõ a legutóbbi R verzió több platformra, az R telepíto állományok 
# forráskódja és ez szintén több ezer ún. "user contributed" csomag tárolója. 

# https://cran.r-project.org/doc/manuals/r-release/R-intro.html
# https://www.rdocumentation.org/

# Integrált fejlesztõi környezet az R-hez:
# https://www.rstudio.com/products/rstudio/

# R Markdown: egyszerû szintaxist biztosít dokumentumok sima szöveg
# formájában történõ írásához, melybõl többféle kimenet
# (például HTML, PDF) állítható elõ.
# Lehetõvé teszi R kódrészek beágyazását a dokumentumokba.
...
1/0
0/0  # NaN: not a number, nem összekeverendõ NA-val (üres elem)
Inf-Inf
...
head(df2)	# ha túl hosszú egy data.frame, csak elsõ néhány sorát kérdezzük le
names(df2)
...
# - külön parancsokkal kell a ábra paramétereit beállítani; ábra képernyon, képként menthetõ
