...
# Példa:  négy egyforma érmét feldobva a megfigyelhetõ kimenetelek: 
# 4 fej,   3 fej és 1 írás,   2 fej és 2 írás,   1 fej és 3 írás,   4 írás
# Ezek valószínûsege a 16-elemû eseméytéren kombinatorikus valószínûseggel 
# számolva (az érméket képzeletben megkülönböztetve) könnyen kiszámolható:
# P(4F) = 1/16 = 0,0625
# P(3F és 1Í) = 4/16 = 0,25
# P(2F és 2Í) = 6/16 = 0,375
# P(1F és 2Í) = 4/16 = 0,25
# P(4írás)=1/16 = 0,0625

dbinom(0:4, size=4, prob=0.5)

# Bernoulli kísérlet: Tfh. a vizsgált kísérletnek 2 lehetséges kimenetele van (pl. F és I),
...
1. ### Táblás gyakorlat 2.2 Feladat ###
...
2. ### Táblás gyakorlat 2.12 a), b) Feladat ###
